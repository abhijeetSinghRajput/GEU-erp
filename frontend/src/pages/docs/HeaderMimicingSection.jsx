      ...
      <div className="bg-green-50 dark:bg-green-950/20 p-4 sm:p-6 rounded-lg border border-green-200 dark:border-green-800">
        ...
        <ul className="text-green-700 dark:text-green-300 space-y-2">
          <li className="flex items-start gap-2">
            ...
            <span><strong>Legitimate Authentication:</strong> Users provide real credentials</span>
          </li>
          <li className="flex items-start gap-2">
            <CheckCircle className="w-4 h-4 mt-1" />
            <span><strong>Proper Session Handling:</strong> Maintain official GEU sessions</span>
          </li>
          <li className="flex items-start gap-2">
            <CheckCircle className="w-4 h-4 mt-1" />
            <span><strong>Respect Rate Limits:</strong> Don't overwhelm GEU servers</span>
          </li>
          <li className="flex items-start gap-2">
            <CheckCircle className="w-4 h-4 mt-1" />
            <span><strong>No Data Storage:</strong> We don't store sensitive user data</span>
          </li>
        </ul>
      </div>
    </div>
