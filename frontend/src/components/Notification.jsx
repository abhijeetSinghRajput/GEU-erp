    ...
    <Popover>
      <PopoverTrigger asChild>
        ...
        >
          ...
          {hasNotifications && (
            <div className="absolute -top-1 -right-1 text-white rounded-full flex justify-center items-center text-[10px] h-5 min-w-5 px-1 bg-red-500 border-2 border-background group-hover:border-accent transition-colors">
